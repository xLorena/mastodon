    ...
    return (
      ...
      >
        ...
        <div className='awareness'>
          <article>
            <h3 className='awareness__caption'>Was ist eine Filterblase?</h3>
            <p className='awareness__citation'>„Eine Welt, die aus dem Bekannten konstruiert ist, ist eine Welt, in der es nichts mehr zu lernen gibt.“ - Eli Pariser</p>
            <p className='awareness__text'>
              Eine Filterblase ist ein Effekt, bei dem einer Person nur Informationen angezeigt werden, die mit ihrer bisherigen Meinung bereits übereinstimmen.
          ...
          <article>
            <h3 className='awareness__caption'>Was kannst du dagegen unternehmen?</h3>
            <p className='awareness__text'>
              Das Bewusstsein über die Existenz von Filterblasen ist der erste Schritt, um diesem Effekt entgegenzuwirken.
          ...
          <article>
            <h3 className='awareness__caption'>Wo kann ich mich weiter darüber informieren?</h3>
            <p className='awareness__subline'>
              Hier sind einige hilfreiche Links für den Anfang, mit denen du dich informieren kannst.
            </p>
            <a className='awareness__link' href='https://www.bpb.de/kurz-knapp/lexika/lexikon-in-einfacher-sprache/303050/filterblase/'>Bundeszentrale für politische Bildung</a>
            <a className='awareness__link' href='https://de.wikipedia.org/wiki/Filterblase'>Wikipedia</a>
            <a className='awareness__link' href='https://books.google.de/books/about/The_Filter_Bubble.html?id=-FWO0puw3nYC&redir_esc=y'>Eli Pariser - The Filter Bubble: What the Internet is hiding from you</a>
            <a className='awareness__link' href='https://www.semanticscholar.org/paper/Exposure-to-ideologically-diverse-news-and-opinion-Bakshy-Messing/c8665198592b52ba122e5cf84032a9bc1c61eade'>Exposure to ideologically diverse news and opinion on Facebook</a>
            <a className='awareness__link' href='https://joinmastodon.org/'>Mastodon</a>
          </article>
        </div>
      </Column>
    );
