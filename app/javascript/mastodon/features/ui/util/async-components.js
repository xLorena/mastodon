...
export function AwarenessInformation() {
  return import(
    /* webpackChunkName: "features/awareness_information" */ '../../awareness_information'
  );
}
export function NewsfeedCompare() {
  return import(
    /* webpackChunkName: "features/newsfeed_compare" */ '../../newsfeed_compare'
  );
}
export function Polarization() {
  return import(
    /* webpackChunkName: "features/polarization" */ '../../polarization'
  );
}
